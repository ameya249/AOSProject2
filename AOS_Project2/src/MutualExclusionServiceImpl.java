...
public class MutualExclusionServiceImpl implements MutualExclusionService {
    ...
    public void cs_enter() {
        ...
        if (Project1.hasToken) {
            ...
            Project1.writeToFile(fileContent);
    ...
    public void cs_leave() {
       ...
       // synchronized(Project1.token)
        ...
        if(Project1.vectorClock.getV()[Project1.processNo]!=Project1.token.getFulfilledRequestsVector()[Project1.processNo])
        {
       ...
       // if (!Project1.token.unfulfilledRequestsQueue.isEmpty()) {
            ...
            Project1.writeToFile(fileContent);
   //         Application.noOfRequests= Application.noOfRequests-1;
     ...
     //       Application.canexecute_cs_leave=false;
            

    	//	if(Application.noOfRequests==0 )
    	//	{
		...
		//		}
    		...
    		//	Application.sendTerminateMessage=true;
